...
def main():
    ...
    front_left_waypoints = action_foot.quadratic_move(front_left_foot, 0.08, -0.04, 10, False, 135)
    front_right_waypoints = action_foot.quadratic_move(front_right_foot, 0.08, -0.04, 10, False, 45)
    middle_left_waypoints = action_foot.quadratic_move(middle_left_foot, 0.08, 0.04, 10, False, 0)
    middle_right_waypoints = action_foot.quadratic_move(middle_right_foot, 0.08, -0.04, 10, False, 0)
    end_left_waypoints = action_foot.quadratic_move(end_left_foot, 0.08, 0.04, 10, False, 45)
    end_right_waypoints = action_foot.quadratic_move(end_right_foot, 0.08, 0.04, 10, False, 135)
