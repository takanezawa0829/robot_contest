...
def main():
    ...
    front_left_waypoints = action_foot.linear_move(front_left_foot, -0.01, 0, 0)
    front_right_waypoints = action_foot.linear_move(front_right_foot, -0.01, 0, 0)
    middle_left_waypoints = action_foot.linear_move(middle_left_foot, -0.01, 0, 0)
    middle_right_waypoints = action_foot.linear_move(middle_right_foot, -0.01, 0, 0)
    end_left_waypoints = action_foot.linear_move(end_left_foot, -0.01, 0, 0)
    end_right_waypoints = action_foot.linear_move(end_right_foot, -0.01, 0, 0)
