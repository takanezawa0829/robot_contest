...
foot = {
    ...
    'front': {
        'left': {
            ...
            'reverse': [False, True, True], # サーボの回転方向を逆にするか [第1関節, 第2関節, 第3関節]
            'max': [600, 600, 700], # サーボモータの最大値
            'min': [400, 400, 500], # サーボモータの最小値
        },
        'right': {
            'id': [4, 5, 6], # サーボのID [第1関節, 第2関節, 第3関節]
            'rev': ['rev4', 'rev5', 'rev6'], # urdfのjointの名前 [第1関節, 第2関節, 第3関節]
            'standard': [500, 450, 400], # 関節角度が0度のときのサーボモータの値 [500, 500, 200]付近を推薦
            'reverse': [False, True, True], # サーボの回転方向を逆にするか [第1関節, 第2関節, 第3関節]
            'max': [600, 550, 500], # サーボモータの最大値
            'min': [400, 350, 300], # サーボモータの最小値
        },
    },
    # 真ん中の脚
    'middle': {
        'left': {
            ...
            'standard': [500, 520, 600], # 関節角度が0度のときのサーボモータの値 [500, 500, 200]付近を推薦
            'reverse': [False, True, True], # サーボの回転方向を逆にするか [第1関節, 第2関節, 第3関節]
            'max': [600, 620, 700], # サーボモータの最大値
            'min': [400, 420, 500], # サーボモータの最小値
        },
        'right': {
            'id': [10, 11, 12], # サーボのID [第1関節, 第2関節, 第3関節]
            'rev': ['rev10', 'rev11', 'rev12'], # urdfのjointの名前 [第1関節, 第2関節, 第3関節]
            'standard': [500, 500, 400], # 関節角度が0度のときのサーボモータの値 [500, 500, 200]付近を推薦
            'reverse': [False, True, True], # サーボの回転方向を逆にするか [第1関節, 第2関節, 第3関節]
            'max': [600, 600, 500], # サーボモータの最大値
            'min': [400, 400, 300], # サーボモータの最小値
        },
    },
    # 後ろ脚
    'end': {
